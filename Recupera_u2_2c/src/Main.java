...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (!Recovery2CService.esCodigoValido(codigo) == false) {
            ...
            if (sc.hasNextInt()) {
                ...
                if (!Recovery2CService.esCategoriaValida(categoria)==true) {
                ...
                if (!Recovery2CService.esHoraValida(horas) == false) {
                    System.out.println("Horas inválidas");
                    continue;
                }
                ...
                if (Recovery2CService.requiereAutorizacion(categoria, horas)==true) {
